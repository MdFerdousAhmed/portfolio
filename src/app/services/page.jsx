           ...
           {services.map((service, index) => {
            return <div key={index} className='flex-1 flex flex-col justify-center gap-6 group'>
              ...
              <div className='w-full flex justify-between items-center'>
                <div className='text-5xl font-extrabold leading-none text-outline text-transparent group-hover:text-green-400 transition-all duration-500'>
                  {service.num}
                </div>
                <Link href={service.href} className='w-[70px] h-[70px] rounded-full bg-white group-hover:bg-green-400 transition-all duration-500 flex justify-center items-center hover:-rotate-45'>
